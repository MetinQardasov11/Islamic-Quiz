    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purpose', models.CharField(choices=[('email_verification', 'E-posta Doğrulama'), ('password_reset', 'Şifre Sıfırlama')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.PositiveSmallIntegerField(choices=[(1, 'Acemi'), (2, 'Başlangıç'), (3, 'Orta'), (4, 'İleri'), (5, 'Uzman')], default=1)),
